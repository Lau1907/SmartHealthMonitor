...
/**
 * Activity de SmartHealth TV con Compose for TV (Sesión 12).
 * Reemplaza a MainActivity + MainFragment (Leanback, Sesión 11).
 * Rutas:
 *  - catalog: TvCatalogScreen (antes MainFragment/BrowseSupportFragment)
 *  - detail/{lecturaId}: TvDetailScreen
 *  - playback: TvPlaybackScreen
 */
...
// Commit sugerido: feat(tv): add Navigation Compose with catalog/detail/playback routes